...
* WebSocket: [https://github.com/phasecoin/insight-api-phase#web-socket-api](https://github.com/phasecoin/insight-api-phase#web-socket-api) 
* API: [https://github.com/phasecoin/insight-api-phase#instantsend-transactions](https://github.com/phasecoin/insight-api-phase#instantsend-transactions) 
...
By default, the Phase Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Phase Core daemon:
