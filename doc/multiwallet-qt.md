...
Only requiring some minor changes is phase.cpp.
...
Changes to phase.cpp
----------------------
phase.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
