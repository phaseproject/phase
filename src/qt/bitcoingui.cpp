    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Phase Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and phase: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Phase Core"), this);
    aboutAction->setStatusTip(tr("Show information about Phase Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Phase Core"));
    ...
    openAction->setStatusTip(tr("Open a phase: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Phase Core help message to get a list with possible Phase Core command-line options"));
...
{
    QString strTitle = tr("Phase Core"); // default title
