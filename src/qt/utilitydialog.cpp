    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Phase Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Phase Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  phase-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Phase in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
PrivateSend uses an phasetive process to mix your inputs with the inputs of two other people, without having your coins ever leave your wallet. \
...
These denominations are 0.01 PHASE, 0.1 PHASE, 1 PHASE and 10 PHASE -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://phasecoin.atlassian.net/wiki/display/DOC/PrivateSend\">https://phasecoin.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Phase Core is shutting down...") + "<br /><br />" +
