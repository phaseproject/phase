...
unsigned int static DarkGravityWave(const CBlockIndex* pindexLast, const Consensus::Params& params) {
    /* current difficulty formula, phase - DarkGravity v3, written by Evan Duffield - evan@phasecoin.io */
    const CBlockIndex *BlockLastSolved = pindexLast;
    const CBlockIndex *BlockReading = pindexLast;
    ...
    arith_uint256 PastDifficultyAverage;
    arith_uint256 PastDifficultyAveragePrev;
    int64_t powTargetSpace = pindexLast->nHeight > params.nPhaseForkBlock ? params.nPowNewTargetSpacing : params.nPowTargetSpacing;
...
int64_t GetBlockProofEquivalentTime(const CBlockIndex& to, const CBlockIndex& from, const CBlockIndex& tip, const Consensus::Params& params)
{
    ...
    int64_t powTargetSpace = tip.nHeight > params.nPhaseForkBlock ? params.nPowNewTargetSpacing : params.nPowTargetSpacing;
