/* src/config/phase-config.h.  Generated from phase-config.h.in by configure.  */
/* src/config/phase-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef PHASE_CONFIG_H

#define PHASE_CONFIG_H
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Phase Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Phase Core"
...
#define PACKAGE_BUGREPORT "https://github.com/phasecoin/phasecoin/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Phase Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Phase Core 2.1.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "phasecore"
