...
static const vector<MasternodeLevel> COLLATERALS = {
		MasternodeLevel(LEVEL1, 5000*COIN),
		MasternodeLevel(LEVEL2, 10000*COIN),
		MasternodeLevel(LEVEL3, 20000*COIN),
		MasternodeLevel(LEVEL4, 30000*COIN)
};
static const int OLD_COLLATERAL_STOP_HEIGHT = 90000;
static const int LEVEL_COLLATERAL_START_HEIGHT = 85000;
