...
static const CAmount MN_COLLATERAL                          = 5000;
//
...
//
// The Masternode Class. For managing the Darksend process. It contains the input of the 5000 PHASE, signature to prove
