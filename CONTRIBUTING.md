Contributing to Phase Core
============================

The Phase Core project operates an open contributor model where anyone is welcome to contribute towards development in the form of peer review, testing and patches. This document explains the practical process and guidelines for contributing.
...
The following applies to code changes to the Phase Core project (and related projects such as libsecp256k1), and is not to be confused with overall Proton Network Protocol consensus changes.

Whether a pull request is merged into Phase Core rests with the project merge maintainers and ultimately the project lead.
...
The project leader is the release manager for each Phase Core release.
